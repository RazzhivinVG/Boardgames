...
public abstract class Hilt_AddEditFilmFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditFilmFragment() {
    super();
  }

  Hilt_AddEditFilmFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((AddEditFilmFragment_GeneratedInjector) this.generatedComponent()).injectAddEditFilmFragment(UnsafeCasts.<AddEditFilmFragment>unsafeCast(this));
  }
