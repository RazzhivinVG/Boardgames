...
public abstract class Hilt_FilmsListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FilmsListFragment() {
    super();
  }

  Hilt_FilmsListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((FilmsListFragment_GeneratedInjector) this.generatedComponent()).injectFilmsListFragment(UnsafeCasts.<FilmsListFragment>unsafeCast(this));
  }
